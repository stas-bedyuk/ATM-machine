...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button14->Location = System::Drawing::Point(148, 154);
			this->button14->Margin = System::Windows::Forms::Padding(2);
			this->button14->Name = L"button14";
			this->button14->Size = System::Drawing::Size(56, 37);
			this->button14->TabIndex = 31;
			this->button14->Text = L"SUM";
			this->button14->UseVisualStyleBackColor = false;
			this->button14->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// textBox2
			// 
			...
			this->textBox2->Location = System::Drawing::Point(200, 154);
			...
			this->textBox2->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// button13
			// 
			...
			this->button13->Font = (gcnew System::Drawing::Font(L"Swis721 Hv BT", 10.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button13->Location = System::Drawing::Point(148, 89);
			this->button13->Margin = System::Windows::Forms::Padding(2);
			this->button13->Name = L"button13";
			this->button13->Size = System::Drawing::Size(56, 37);
			this->button13->TabIndex = 29;
			this->button13->Text = L"+375";
			this->button13->UseVisualStyleBackColor = false;
			this->button13->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// button12
			// 
			...
			this->button12->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button12->Location = System::Drawing::Point(330, 342);
			...
			this->button12->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// button11
			// 
			...
			this->button11->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button11->Location = System::Drawing::Point(330, 276);
			...
			this->button11->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// button10
			// 
			...
			this->button10->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button10->Location = System::Drawing::Point(330, 210);
			...
			this->button10->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// button9
			// 
			...
			this->button9->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button9->Location = System::Drawing::Point(269, 342);
			...
			this->button9->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// button8
			// 
			...
			this->button8->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button8->Location = System::Drawing::Point(208, 342);
			...
			this->button8->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// button7
			// 
			...
			this->button7->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button7->Location = System::Drawing::Point(148, 342);
			...
			this->button7->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// button6
			// 
			...
			this->button6->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button6->Location = System::Drawing::Point(269, 276);
			...
			this->button6->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// button5
			// 
			...
			this->button5->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button5->Location = System::Drawing::Point(208, 276);
			...
			this->button5->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// button4
			// 
			...
			this->button4->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button4->Location = System::Drawing::Point(148, 276);
			...
			this->button4->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// button3
			// 
			...
			this->button3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button3->Location = System::Drawing::Point(269, 210);
			...
			this->button3->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// button2
			// 
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button2->Location = System::Drawing::Point(208, 210);
			...
			this->button2->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// button1
			// 
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->button1->Location = System::Drawing::Point(148, 210);
			...
			this->button1->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// textBox1
			// 
			...
			this->textBox1->Location = System::Drawing::Point(200, 89);
			...
			this->textBox1->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// textBox3
			// 
			this->textBox3->BackColor = System::Drawing::Color::Azure;
			this->textBox3->Font = (gcnew System::Drawing::Font(L"Dutch801 XBd BT", 19.8F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox3->Location = System::Drawing::Point(11, 11);
			this->textBox3->Margin = System::Windows::Forms::Padding(2);
			this->textBox3->Name = L"textBox3";
			this->textBox3->ReadOnly = true;
			this->textBox3->Size = System::Drawing::Size(208, 39);
			this->textBox3->TabIndex = 32;
			this->textBox3->Text = L"MAX: 200 BYN";
			...
			this->button15->Font = (gcnew System::Drawing::Font(L"Dutch801 XBd BT", 20.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button15->Location = System::Drawing::Point(470, 220);
			...
			this->button15->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// button16
			// 
			this->button16->BackColor = System::Drawing::Color::Red;
			this->button16->Font = (gcnew System::Drawing::Font(L"Dutch801 XBd BT", 20.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button16->Location = System::Drawing::Point(470, 297);
			...
			this->button16->Click += gcnew System::EventHandler(this, &MyForm7::button11_Click);
			// 
			// MyForm7
			// 
...
#pragma endregion
	private: System::Void button11_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		if (sender == button10 && textBox2->Text->Length != 0 && textBox1->Text->Length != 0)
		{
			string sum1 = msclr::interop::marshal_as<std::string>(textBox2->Text);
			int sum_int1 = stoi(sum1);
			Base s;
			s.read();
			if (sum_int1 <= 200 && i==9 && j>=1 && s.debiting(sum_int1)==0)
			{
			
				s.write();
				s.write_base();
				MessageBox::Show("THE OPERATION WAS COMPLETED SUCCESSFULLY", "THE PHONE HAS BEEN REPLENISHED", MessageBoxButtons::OK);
			}
			else if (sum_int1 <= 200 && 0 > s.debiting(sum_int1))
			{
				MessageBox::Show("YOU DON'T HAVE ENOUGH FUNDS", "ERROR!", MessageBoxButtons::OK, MessageBoxIcon::Warning);
			}
			else
			{
				MessageBox::Show("SUM MORE THAN 200 BYN OR UNCORRECT NUMBER OF PHONE", "ERROR!", MessageBoxButtons::OK, MessageBoxIcon::Warning);
